...
open class CandleChartDataSet: LineScatterCandleChartDataSet
{
    ...
    /// the width of the candle-average-line in pixels.
    /// :default: 2.0
    open var avgLineWidth = CGFloat(1)
    ...
    /// color for average five
    open var averageFive: UIColor = UIColor.purple
    
    /// color for average ten
    open var averageTen: UIColor = UIColor.orange
    
    /// color for average twenty
    open var averageTwenty: UIColor = UIColor.blue
