...
open class ChartLimitLine: ChartComponentBase
{
    ...
    open var valueTextColor = UtilColor.getTextBlackColor()
    open var valueFont = UIFont.normalFontOfSize(13.0)
    open var label = ""
    open var labelPosition = ChartLimitLabelPosition.rightTop
